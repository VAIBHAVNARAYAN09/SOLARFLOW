...
const navigation = [
  ...
  { name: "Weather Forecast", href: "/weather-forecast", icon: Cloud },
  ...
  useEffect(() => {
    function handleResize() {
      if (window.innerWidth >= 1024) {
        ...
        // This is a no-op since we're not changing state
      }
    }
  ...
  return (
    <>
      ...
      <div
        id="sidebar"
        className={cn(
          "fixed inset-y-0 left-0 z-50 w-64 bg-white dark:bg-gray-900 border-r border-gray-200 dark:border-gray-800 shadow-lg transform transition-transform duration-300 ease-in-out lg:translate-x-0",
        ...
        <div className="flex flex-col h-full">
          ...
          <div className="border-t p-4">
            <div className="flex items-center space-x-3">
              ...
              <div>
                <p className="font-medium dark:text-slate-200">John Doe</p>
